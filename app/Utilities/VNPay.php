...
class VNPay
{
     ...
     *
     */
    static $vnp_TmnCode = "MY5750L5"; //Mã website tại VNPAY
    static $vnp_HashSecret = "RVBURETPSSCDYMJGILAVZZHENSLQXEGC"; //Chuỗi bí mật
    ...
    public static function vnpay_create_payment(array $data)
    {
        ...
        return $returnData; //chỉ lấy ra $vnp_Url thôi.
    }
}
