...
class ProductRepository extends BaseRepositories implements ProductRepositoryInterface
{
    ...
    public function getProductOnIndex($request) //phan trang
    {

        $search = $request->search ?? '';
        $products = $this->model->where('name', 'like', '%' . $search . '%');
        $products = $this->filter($products, $request);
        $products = $this->sortAndPaqination($products, $request);
    ...
    private function sortAndPaqination($products, $request)
    {
