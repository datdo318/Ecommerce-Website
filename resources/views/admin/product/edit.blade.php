                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="content" id="content"
                                        placeholder="Nhập nội dung" type="text" class="form-control" value="{{ $product->content }}">
                                </div>
                            </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="price" id="price"
                                        placeholder="Nhập giá" type="text" class="form-control" value="{{ $product->price }}">
                                </div>
                            </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="discount" id="discount"
                                        placeholder="Nhập giá khuyến mại" type="text" class="form-control" value="{{ $product->discount }}">
                                </div>
                            </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="weight" id="weight"
                                        placeholder="Nhập khối lượng" type="text" class="form-control" value="{{ $product->weight }}">
                                </div>
                            </div>
