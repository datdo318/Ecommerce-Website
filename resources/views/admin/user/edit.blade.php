                    ...
                    <div class="card-body">
                        <form method="post" action="/admin/user/{{ $user->id }}" enctype="multipart/form-data">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="company_name" id="company_name"
                                        placeholder="Nhập tên công ty" type="text" class="form-control"
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="country" id="country" placeholder="Nhập tên quốc gia"
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="street_address" id="street_address"
                                        placeholder="Nhập địa chỉ" type="text" class="form-control"
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="postcode_zip" id="postcode_zip"
                                        placeholder="Nhập mã bưu điện" type="text" class="form-control"
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="town_city" id="town_city" placeholder="Nhập tên thành phố"
