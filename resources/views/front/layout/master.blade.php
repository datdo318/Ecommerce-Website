            ...
            <div class="inner-header">
                <div class="row">
                    <div class="col-lg-2 col-md-2">
                        <div class="logo">
                            <a href="/">
                                {{-- <img src="front/img/logo.png"  width="100px" alt=""> --}}
                                <h4>Fashion shop</h4>
                            </a>
                        </div>
                    </div>
                        ...
                        <form action="shop">
                            <div class="advanced-search">
                                ...
                                <div class="input-group">
                                    <input name="search" value="{{ request('search') }}" type="text" placeholder="Bạn cần tìm kiếm?">
                    ...
                    <div class="col-lg-3 col-md-3 text-right">
                        <ul class="nav-right">
                            ...
                            <li class="cart-icon">
                                ...
                                <div class="cart-hover">
                                                    ...
                                                    <tr data-rowId="{{ $cart->rowId }}"> 
                                                        ...
                                                        <td class="si-text">
                                                            <div class="product-selected">
                                                                <p>đ{{number_format($cart->price, 0, ',', '.')}} x {{ $cart->qty }}</p>
                                                                <h6>{{ $cart->name }}</h6>
                                                            </div>
                                                        </td>
                                                        <td class="si-close">
                                    ...
                                    <div class="select-total">
                                        <span>total:</span>
                                        <h5>đ{{ number_format(Cart::totalFloat(), 0, ',', '.') }}</h5>
                                    </div>
                            ...
                            <li class="cart-price">đ{{ number_format(Cart::totalFloat(), 0, ',', '.') }}</li>                          
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="nav-depart">
                    <div class="depart-btn">
                        ...
                        <ul class="depart-hover">
                            <li class="active"><a href="./shop/category/Nữ">Nữ</a></li>
                            <li><a href="./shop/category/Nam">Nam</a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="newslatter-item">
                        ...
                        <p>Nhận thông tin cập nhật qua email về các ưu đãi đặc biệt mới nhất của cửa hàng chúng tôi.</p>
